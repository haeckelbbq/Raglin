...
switch ($action)
{
    ...
    case ($action === 'anzeige');  // anzeige öffnet im Folgenden die einzelnen Views
    {
        ...
        elseif ($area === 'kampf')
        {
            ...
            $gegenstaende = Gegenstand::getGegenstandeByCharakterId($charakter->getCid());
            echo $gegenstaende[0]->getGegname();
    ...
    case ($action === 'update');
    {
        ...
        {
            //Verbessere die Werte des Charakters Methode updateCharakter() z.B.
            $user_id = $_SESSION['user_id'];
        ...
        if ($area === 'charakter')
        {
            ...
            else
            {
                Charakter::insertCharakter($user_id, $name,$rasse,$ausstrahlung, $beweglichkeit, $intuition, $konstitution,
                    $mystik, $staerke, $verstand, $willenskraft,$startausstrahlung, $startbeweglichkeit, $startintuition, $startkonstitution,
                    $startmystik, $startstaerke, $startverstand, $startwillenskraft);  // Werte kommen vom User aus der Charakterbogenanzeige
