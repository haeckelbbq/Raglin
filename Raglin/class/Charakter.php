                                           ...
                                           int $startmystik, int $startstaerke, int $startverstand, int $startwillenskraft)
    {
        ...
        try {
            ...
            $sql = 'INSERT INTO charakter(cid, fk_user, fk_aktivewaffe, fk_aktiveruestung, fk_aktivesschild,
                                ...
                                startintuition, startkonstitution,startmystik, startstaerke, verstand ,willenskraft, ausstrahlung, beweglichkeit,
                        ...
                        VALUES(NULL, :fk_user, 1, 1, 1, :cname, 250, 0, :lebenspunktemax, 
                                     :lebenspunkteakt, :ausstrahlung, :beweglichkeit, :intuition, :konstitution, :mystik, :staerke, :verstand, :willenskraft, :startausstrahlung, :startbeweglichkeit, :startintuition, :startkonstitution, :startmystik, :startstaerke, :startverstand, :startwillenskraft,0,0,0,0,0,0, :rasse,0)';
            $sth = $dbh->prepare($sql);;
